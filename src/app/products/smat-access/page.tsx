...
const DeviceCard: React.FC<DeviceCardProps> = ({ device, onLearnMore }) => (
  <div
    className="relative flex flex-col items-center justify-center p-6 overflow-hidden text-center text-white bg-black rounded-xl"
    style={{ backgroundColor: "#07162b" }}
  >
    ...
    <div className="relative z-10 flex flex-col items-center">
      <h3 className="text-3xl font-bold leading-tight md:text-4xl">
        <span className="font-light">Smat</span> <br />
        {device.title}
      </h3>
...
export default function SmatAccess() {
  ...
  const schema = {
    ...
    name: "SmatAccess",
    description:
      "SmatAccess is a complete physical access control solution that integrates advanced software with purpose-built devices to manage and monitor all access points, offering enhanced security, real-time monitoring, and scalable access management.",
    brand: { "@type": "Brand", name: "Sharetek Group" },
    url: "https://Sharetekgroup.com/products/smataccess",
    logo: "https://Sharetekgroup.com/smataccess_logo.svg",
    image: "https://Sharetekgroup.com/smataccess_hero_image.png",
    offers: {
      "@type": "Offer",
      priceCurrency: "USD",
  ...
  const useCases = [
    {
      icon: <FaSchool className="w-10 h-10 text-primary" />,
      title: "Schools & Institutions",
      description: "Manage building and campus access safely.",
      link: "#",
    },
    {
      icon: <FaBuilding className="w-10 h-10 text-primary" />,
      title: "Corporate Offices",
      description: "Secure offices, meeting rooms, and restricted areas.",
      link: "#",
    },
    {
      icon: <FaHome className="w-10 h-10 text-primary" />,
      title: "Residential Complexes",
      description: "Manage multiple entry points efficiently.",
      link: "#",
    },
    {
      icon: <FaHospital className="w-10 h-10 text-primary" />,
      title: "Healthcare Facilities",
      description: "Control access to sensitive areas and patient rooms.",
      link: "#",
    },
    {
      icon: <FaIndustry className="w-10 h-10 text-primary" />,
      title: "Manufacturing Sites",
      description: "Strict control for high-risk zones.",
      link: "#",
    },
    {
      icon: <FaTicketAlt className="w-10 h-10 text-primary" />,
      title: "Event Venues",
      description: "Manage large crowds and staff access levels.",
      link: "#",
    },
    {
      icon: <FaLandmark className="w-10 h-10 text-primary" />,
      title: "Government Buildings",
      description: "Monitor and control sensitive areas.",
      link: "#",
    },
    {
      icon: <FaStore className="w-10 h-10 text-primary" />,
      title: "Retail & Commercial",
      description: "Secure storage, cash offices, and high-traffic areas.",
      link: "#",
    },
  ];
  ...
  const propertyManagementFeatures = [
    {
      ...
      description:
        "Generate secure, time-bound QR codes for visitors, contractors, or deliveries. Gatekeepers simply scan to validate access—no unauthorized entry, no guesswork.",
    },
    {
      icon: <FaUserCheck className="w-10 h-10" />,
      title: "Premium Tenant Experience",
      description:
        "Deliver a modern, tech-driven property environment that enhances convenience, safety, and a professional brand image.",
    },
    {
      icon: <FaRocket className="w-10 h-10" />,
      title: "Scalable & Future-Ready",
      description:
        "Built to grow with your property portfolio, SmatAccess integrates easily with SmatProp and other Sharetek solutions.",
    },
    {
      icon: <FaShieldAlt className="w-10 h-10" />,
      title: "End-to-End Security",
      description:
        "Advanced features like guest codes, facial recognition, and plate recognition eliminate loopholes and ensure complete property safety.",
    },
  ];
  ...
  return (
    <div className="bg-gray-50">
      ...
      <section className="relative px-6 py-32 md:px-24">
        ...
        >
          ...
          >
            ...
            <h1 className="text-sm font-bold text-primary lg:text-2xl">
              SmatAccess
            </h1>
          </motion.div>
          ...
          >
            ...
            <span className="text-primary">SmatAccess</span>
          </motion.h2>

          {/* Paragraph */}
          <motion.p variants={fadeUpVariant} className="max-w-2xl text-xl">
            A complete physical access control solution that integrates advanced
            software with purpose-built devices to manage and monitor all access
            points.
          </motion.p>
      ...
      >
        <div className="space-y-4 md:w-1/2">
          ...
          <p className="text-lg text-black">
            SmatAccess provides a robust, scalable, and intelligent access
            control system designed to protect what matters most. From corporate
            offices to educational institutions, our solution ensures that only
            authorized individuals can access designated areas, all while
            providing real-time oversight and detailed analytics.
          </p>
        ...
        <div className="relative md:w-1/2 h-96 rounded-xl">
          <Image
            ...
            alt="SmatAccess system showing dashboard"
            fill
        ...
        <div className="container px-6 mx-auto md:px-24">
          <AnimatedSection className="mb-16 text-center">
            <h2 className="mb-4 text-4xl font-bold text-primary">
              Smart Access & Security for <br />
              <span className="text-gray-800">Modern Property Management</span>
            </h2>
            <p className="max-w-3xl mx-auto text-xl text-gray-600">
              Our tailored solution is designed to optimize security,
              convenience, and operations for modern residential and commercial
              complexes.
            </p>
          </AnimatedSection>
      ...
      <section className="px-6 py-16 bg-gray-100 md:px-24">
        <AnimatedSection className="mb-12 text-center">
          ...
          <p className="max-w-4xl mx-auto text-lg text-gray-600">
            Experience advanced property access control with seamless
            integration and state-of-the-art security technology.
          </p>
        </AnimatedSection>
        ...
        <div className="container px-6 mx-auto md:px-24">
          <AnimatedSection className="mb-12 text-center">
            ...
            <p className="text-xl text-gray-600">
              The hardware that powers a new era of access control.
            </p>
          </AnimatedSection>
          ...
          >
            {deviceData.map((device, index) => (
              <motion.div key={device.title} variants={fadeIn}>
                <DeviceCard device={device} onLearnMore={handleLearnMore} />
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <section
        ...
        style={{ backgroundColor: "rgba(160, 9, 39, 0.05)" }}
      >
        <motion.div
          initial="hidden"
          whileInView="visible"
      ...
      <section className="px-6 py-16 bg-gray-100 md:px-24">
        <AnimatedSection>
          <h2 className="mb-12 text-3xl font-bold text-center text-gray-800">
            Additional Use Cases of SmatAccess
          </h2>
        </AnimatedSection>
          ...
          {useCases.map((useCase, index) => (
            <AnimatedCard key={index} delay={index * 100}>
              <div className="flex flex-col items-center h-full p-6 text-center bg-white rounded-lg shadow-md">
                <div className="mb-4 transition-transform duration-500 hover:rotate-12">
                  {useCase.icon}
                </div>
                <h3 className="mb-2 text-xl font-semibold text-gray-800">
                  {useCase.title}
                ...
                <a
                  href={useCase.link}
                  className="flex items-center gap-2 mt-auto font-semibold text-primary hover:underline"
                >
      ...
      {/* Final CTA Section */}
      <section className="px-6 py-16 text-center text-white bg-primary">
        <h2 className="mb-4 text-3xl font-bold">
          Ready to Transform Your Access Control?
        </h2>
        <p className="max-w-2xl mx-auto mb-8 text-xl">
          Get in touch with our team to discuss how SmatAccess can meet your
          security needs
        </p>
